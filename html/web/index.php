         ...
         <div class="container-fluid">
                        ...
                        <div class="row banner_slider">
                            <div class="col-xl-12">
                                <div class="single_slider">
                                   <img src="images/graphics/banner1.webp">
                                </div>
                            </div>
                                                        <div class="col-xl-12">
                                <div class="single_slider">
                                   <img src="images/graphics/banner2.webp">
                                </div>
                            </div>
                                                        <div class="col-xl-12">
                                <div class="single_slider">
                                   <img src="images/graphics/banner3.webp">
                                </div>
                            </div>
                                                        <div class="col-xl-12">
                                <div class="single_slider">
                                   <img src="images/graphics/banner4.webp">
                                </div>
                            </div>
            ...
            <div class="col-lg-12">
                <div class="banners owl-carousel owl-theme">
                   <div class="item"><img src="images/graphics/banner1.webp"></div>
                   <div class="item"><img src="images/graphics/banner2.webp"></div>
                   <div class="item"><img src="images/graphics/banner3.webp"></div>
                   <div class="item"><img src="images/graphics/banner4.webp"></div>
               </div>
            </div>
         </div>
      </section>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 wow fadeInUp">
                    <div class="blog_item">
                        <div class="blog_img">
                            <img src="images/blog_2_img_1.jpg" alt="blog" class="img-fluid w-100">
                        </div>
                        <div class="blog_text">
                            <ul class="top">
                            ...
                            <ul class="bottom">
                                <li><a href="blogs.php">read more <i class="fas fa-long-arrow-right"></i></a>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp">
                    <div class="blog_item">
                        <div class="blog_img">
                            <img src="images/blog_2_img_2.jpg" alt="blog" class="img-fluid w-100">
                        </div>
                        <div class="blog_text">
                            <ul class="top">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp">
                    <div class="blog_item">
                        <div class="blog_img">
                            <img src="images/blog_2_img_3.jpg" alt="blog" class="img-fluid w-100">
                        </div>
                        <div class="blog_text">
                            <ul class="top">
