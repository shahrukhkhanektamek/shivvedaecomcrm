...
class BranchController extends Controller
{
     protected $arr_values = array(
        ...
        "folder_name"=>'/branch',
        "upload_path"=>'upload/',
        "page_name"=>'branch-detail.blade.php',
        "keys"=>'id,name',
    ...
    public function load_data(Request $request)
    {
      ...
      $data_list = Branch::where(['status' => $status])->orderBy('id',$order_by);
    ...
    public function update(Request $request)
    {
        ...
        if(empty($id)) $data = new Branch;
        else $data = Branch::find($id);
