...
class HomeBannerController extends Controller
{
     protected $arr_values = array(
        'routename'=>'home-banner.', 
        'title'=>'Home Banner', 
        'table_name'=>'home_banner',
        'page_title'=>'Home Banner',
        "folder_name"=>'/home-banner',
        "upload_path"=>'upload/',
    ...
    public function load_data(Request $request)
    {
      ...
      $data_list = HomeBanner::where(['status' => $status])->orderBy('id',$order_by);
    ...
    {   
        ...
        $row = HomeBanner::where(["id"=>$id,])->first();
        if(!empty($row))
        {
            return view($this->arr_values['folder_name'].'/form',compact('data','row'));
        }
    ...
    public function update(Request $request)
    {
        ...
        if(empty($id)) $data = new HomeBanner;
        else $data = HomeBanner::find($id);
