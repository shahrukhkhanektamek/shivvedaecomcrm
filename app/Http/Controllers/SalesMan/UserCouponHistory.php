...
class UserCouponHistory extends Controller
{
     protected $arr_values = array(
        'routename'=>'user.coupon.', 
        'title'=>'Coupon', 
        'table_name'=>'coupon',
        'page_title'=>'Coupon',
        "folder_name"=>user_view_folder.'/coupon',
        "upload_path"=>'upload/',
        "keys"=>'id,name',
       );  
    ...
    public function load_data(Request $request)
    {
      ...
      $status = $request->status;
        ...
        $data_list = Orders::where('orders.sponser_id',$affiliate_id)
        ->where(['orders.status' => $status])
        ->select("orders.*","users.name","users.affiliate_id","users.name","users.email","users.phone")

        ->leftJoin("users as users","users.id","=","orders.user_id")
    ...
    public function excel_export(Request $request)
    {
      ...
      $affiliate_id = $user_data->affiliate_id;
        ...
        $fileName = "coupon-".date("Y-m-d H-i-s")."-".$Admin_id.".xlsx";
