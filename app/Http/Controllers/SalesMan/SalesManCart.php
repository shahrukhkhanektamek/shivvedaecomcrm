...
class SalesManCart extends Controller
{
     protected $arr_values = array(
        'routename'=>'salesman.cart.', 
        'title'=>'My Cart', 
        'table_name'=>'deposit_request',
        'page_title'=>'My Cart',
        "folder_name"=>'salesman/cart',
        "upload_path"=>'upload/',
        "keys"=>'id,name',
       );  
    ...
    public function load_data(Request $request)
    {
      ...
      $cartDetail = \App\Models\MemberModel::cartDetail($user_id);
      $data_list = $cartDetail['cartProducts'];
