...
class UserDirectTeam extends Controller

{

     protected $arr_values = array(
        'routename'=>'user.direct-team.', 
        'title'=>'Direct Team', 
        'table_name'=>'users',
        'page_title'=>'Direct Team',
        "folder_name"=>user_view_folder.'/direct-team',
        "upload_path"=>'upload/',
...

    {
        ...
        $allIds = MemberModel::allDirectIds($user_id);
    ...
    public function excel_export(Request $request)
    {
        ...
        $fileName = "Direct-Team-".date("Y-m-d H-i-s")."-".$user_id.".xlsx";
        ...
        foreach ($data_list as $value)
        {
            ...
            $position = '';
            if($value->position==1) $position = 'Left';
            if($value->position==2) $position = 'Right';
