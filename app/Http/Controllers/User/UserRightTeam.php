...
class UserRightTeam extends Controller

{

     protected $arr_values = array(

        'routename'=>'user.right-team.', 

        'title'=>'Right Team', 

        'table_name'=>'users',

        'page_title'=>'Right Team',

        "folder_name"=>user_view_folder.'/right-team',
...

    {
        ...
        $checkUser = DB::table('users')->where(['parent_id'=>$user_id,"position"=>2])->first();
    ...
    public function excel_export(Request $request)
    {
        ...
        $fileName = "Right-Team-".date("Y-m-d H-i-s")."-".$user_id.".xlsx";
