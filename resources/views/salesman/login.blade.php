...
<head>
    ...
    <link rel="apple-touch-icon" href="{{url('/public/salesman/')}}/assets/img/logo-512.png">
    ...
    <script defer src="{{url('/public/salesman/')}}/assets/js/app.js?e5e60e3925d7f9a7cded"></script>
    <link href="{{url('/public/salesman/')}}/assets/css/app.css?e5e60e3925d7f9a7cded" rel="stylesheet">
                        ...
                        <div class="container-fluid">
                            <div class="row gx-3 align-items-center justify-content-center py-3 mt-auto z-index-1 height-dynamic" style="--h-dynamic: calc(100vh - 120px)">
                                <div class="col login-box maxwidth-400">
                                    <img src="{{url('/public/salesman/')}}/assets/img/logo.png" alt="" class="height-80 mb-3" style="margin: 0 auto;display: block;">
                                    <div class="mb-4">
                                        <h3 class="text-theme-1 fw-normal mb-0">Welcome to,</h3>
                                        <h1 class="fw-bold text-theme-accent-1 mb-0">{{env('APP_NAME')}}</b></h1>
                                    </div>
                                    <form class="account__form form_data" action="{{route('salesman.salesman-login-action')}}" method="post" enctype="multipart/form-data" id="form_data_submit" novalidate>
                                        @csrf
