                        ...
                        <div class="card mt-4 card-bg-fill">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Sign in to continue to Shivveda.</p>
                                </div>
                                <div class="p-2 mt-4">

                                    <form action="{{route('login')}}" method="post" class="form_data" id="LoginForm">
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                <script>document.write(new Date().getFullYear())</script> {{env("APP_NAME")}}. Developed By <i class="mdi mdi-heart text-danger"></i> by <a href="www.uniquewebcreator.com">Unique Web Creator</a>
                            </p>
                        </div>
                    </div>
                </div>
