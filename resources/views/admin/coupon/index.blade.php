        ...
        <div class="main-content">
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <form class="needs-validation form_data" action="{{$data['submit_date_url']}}" method="post" enctype="multipart/form-data" id="form_data_submit2" novalidate>
                        @csrf
                        @php($coupon = DB::table('coupon')->first())
                        <div class="row">
                            <div class="col-lg-4">
                                <input type="date" class="form-control" name="from_date" value="{{@$coupon->from_date}}" required>
                            </div>
                            <div class="col-lg-4">
                                <input type="date" class="form-control" name="to_date" value="{{@$coupon->to_date}}" required>
                            </div>
                            <div class="col-lg-4">
