        ...
        <div class="main-content">
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <!-- end page title -->
                    <form class="mt-2 needs-validation form_data" action="{{route('user.activate-without-income-action')}}" method="post" enctype="multipart/form-data" id="form_data_submit" novalidate>
                        @csrf
