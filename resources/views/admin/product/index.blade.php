                            ...
                            <div class="card" id="applicationList">
                                <div class="card-header  border-0">
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-md-3">                                            
                                            <!-- <a href="{{$data['excel_import']}}" class="btn btn-primary add-new">Import {{$data['title']}}</a> -->
                                            <a href="{{$data['add_btn_url']}}" class="btn btn-primary add-btn w-100" id="create-btn"><i class="ri-add-line align-bottom me-1"></i> Add New {{$data['title']}}</a>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
