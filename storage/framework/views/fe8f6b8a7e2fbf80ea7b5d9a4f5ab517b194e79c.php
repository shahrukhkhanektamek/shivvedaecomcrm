            ...
            <div class="row payoutsystem" style="align-items: center;">
               <div class="wallet mnwallet wallets">
                 ...
                 <div class="walletcontent">
                   <p>Deposit</p>
                   <h2 class="wallet-balance"><?php echo e(Helpers::price_formate(@\App\Models\MemberModel::getTypeAllIncome(Session::get('user')['id'])->deposit)); ?></h2>
...
<?php echo $__env->make('user.headers.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u171934876/domains/developershahrukh.in/public_html/demo/irshad/shivveda/resources/views/user/wallet/index.blade.php ENDPATH**/ ?>