      ...
      <div class="row">
        ...
        <div class="col-lg-12 mt-3">
          <div class="card card-outline">
            <button type="button" class="btn btn-success" id="excel-export" style="width: fit-content;margin: 10px 20px 0 auto;">Excel</button>            
...
<script>
   ...
   function excel_export()
   {
        ...
        var form = new FormData();
        var settings = {
          "url": "<?php echo e(route('user.direct-team.excel_export')); ?>?"+data,
          "method": "GET",
          "timeout": 0,
          "processData": false,
          "headers": {
...
<?php echo $__env->make('user.headers.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/shivved1/public_html/resources/views/user/direct-team/index.blade.php ENDPATH**/ ?>