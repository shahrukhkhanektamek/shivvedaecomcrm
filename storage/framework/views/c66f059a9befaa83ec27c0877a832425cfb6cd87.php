...
<div class="login-box">
  <div class="login-box-body">
    ...
    <h3 class="login-box-msg mb-2">Login</h3>
      ...
      <div>
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <a href="<?php echo e(route('user.user-forgot')); ?>" class="pull-right"><i class="fa fa-lock"></i> Forgot Password?</a>
          </div>
        </div>
        <!-- /.col -->
    ...
    <div class="m-t-2 dont">Don't have an account? <a href="<?php echo e(route('user.registration')); ?>" class="text-center">Sign Up</a></div>
  </div>
  <!-- /.login-box-body --> 
</div>
<!-- /.login-box --> 
...
</html><?php /**PATH /home/u171934876/domains/developershahrukh.in/public_html/demo/irshad/shivveda/resources/views/user/login.blade.php ENDPATH**/ ?>