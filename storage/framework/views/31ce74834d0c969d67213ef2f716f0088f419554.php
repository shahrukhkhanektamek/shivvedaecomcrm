...
<div class="app-menu navbar-menu">
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="<?php echo e(route('coupon.list')); ?>">
                                <i class="ri-coupon-line"></i> <span data-key="t-dashboards">Coupon</span>
                            </a>
                        </li>                         
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="<?php echo e(route('webinar.list')); ?>">
                                <i class="ri-webcam-line"></i> <span data-key="t-dashboards">Webinar Information</span>
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarWebsite">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link menu-link" href="<?php echo e(route('testimonial.list')); ?>">
                                            <i class="ri-picture-in-picture-line"></i> <span data-key="t-dashboards">Testimonial</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#sidebarBlog" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarBlog" data-key="t-projects">
                                            <i class="ri-question-line"></i>Blog
                                        </a>
                                        <div class="collapse menu-dropdown" id="sidebarBlog">
                                            <ul class="nav nav-sm flex-column">
                                                <li class="nav-item">
                                                    <a class="nav-link menu-link" href="<?php echo e(route('blog-category.list')); ?>">
                                                        <i class="ri-picture-in-picture-line"></i> <span data-key="t-dashboards">Blog Category</span>
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link menu-link" href="<?php echo e(route('blog.list')); ?>">
                                                        <i class="ri-picture-in-picture-line"></i> <span data-key="t-dashboards">Blog</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <div class="collapse menu-dropdown" id="sidebarHomePage">
                                            <ul class="nav nav-sm flex-column">
                                                <li class="nav-item">
                                                    <a class="nav-link menu-link" href="<?php echo e(route('home-banner.index')); ?>">
                                                        <i class="ri-picture-in-picture-line"></i> <span data-key="t-dashboards">Banner</span>
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link menu-link" href="<?php echo e(route('banner-logo.list')); ?>">
                                                        <i class="ri-picture-in-picture-line"></i> <span data-key="t-dashboards">Banner Logo</span>
                                                    </a>
                                                </li>
                                                
                                                <li class="nav-item">
                                                    <a class="nav-link menu-link" href="<?php echo e(route('category-logo.list')); ?>">
                                                        <i class="ri-picture-in-picture-line"></i> <span data-key="t-dashboards">Category Logo</span>
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link menu-link" href="<?php echo e(route('home-counter.index')); ?>">
                                                        <i class="ri-picture-in-picture-line"></i> <span data-key="t-dashboards">Home Counter</span>
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link menu-link" href="<?php echo e(route('faq.list')); ?>">
                                                        <i class="ri-picture-in-picture-line"></i> <span data-key="t-dashboards">FAQ's</span>
                                                    </a>
                                                </li>
                                    ...
                                    <li class="nav-item">
                                        <a href="#sidebarAboutPage" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarAboutPage" data-key="t-projects">
                                            <i class="ri-home-line"></i>About US Page
                                        </a>
                                        <div class="collapse menu-dropdown" id="sidebarAboutPage">
                                            <ul class="nav nav-sm flex-column">
                                                
                                                <li class="nav-item">
                                                    <a class="nav-link menu-link" href="<?php echo e(route('about-us-logo.list')); ?>">
                                                        <i class="ri-picture-in-picture-line"></i> <span data-key="t-dashboards">About Us Logo</span>
                                                    </a>
                                                </li>                                                
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link menu-link" href="<?php echo e(route('privacy-policy.edit')); ?>">
                                            <i class=" ri-file-copy-line"></i> <span data-key="t-dashboards">Privacy Policy</span>
                                        </a>
                                    </li> 
                                    <li class="nav-item">
                                        <a class="nav-link menu-link" href="<?php echo e(route('term-condition.edit')); ?>">
                                            <i class=" ri-file-copy-line"></i> <span data-key="t-dashboards">Terms & Condition</span>
                                        </a>
                                    </li> 
                                    <li class="nav-item">
                                        <a class="nav-link menu-link" href="<?php echo e(route('refund-policy.edit')); ?>">
                                            <i class="ri-refund-line"></i> <span data-key="t-dashboards">Refund Policy</span>
                                        </a>
                                    </li> 
                                    <li class="nav-item">
                                        <a class="nav-link menu-link" href="<?php echo e(route('pricing-policy.edit')); ?>">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarSetting">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link menu-link" href="<?php echo e(route('setting.webinar')); ?>">
                                            <i class=" ri-file-copy-line"></i> <span data-key="t-dashboards">Webinar Page</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link menu-link" href="<?php echo e(route('setting.link-generator')); ?>">
                                            <i class=" ri-file-copy-line"></i> <span data-key="t-dashboards">Link Generator Banner</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link menu-link" href="<?php echo e(route('setting.dashboard')); ?>">
                                            <i class=" ri-file-copy-line"></i> <span data-key="t-dashboards">Dashboard</span>
                                        </a>
                                    </li>
        ...
        <!-- Left Sidebar End --><?php /**PATH C:\xampp\htdocs\projects\ayurvedicmlm\resources\views/admin/headers/header.blade.php ENDPATH**/ ?>