...
<div class="login-box">
  <div class="login-box-body">
    ...
    <form class="account__form form_data" action="<?php echo e(route('user.user-forgot-password-otp-submit')); ?>" method="post" enctype="multipart/form-data" id="form_data_submit" novalidate>
    <?php echo csrf_field(); ?>
      ...
      <div class="form-group has-feedback">
        ...
        <input type="text" maxlength="1" class="otp-input" id="otp-1" oninput="moveFocus(event, 1)" onkeydown="moveFocusOnBackspace(event, 1)">
        <input type="text" maxlength="1" class="otp-input" id="otp-2" oninput="moveFocus(event, 2)" onkeydown="moveFocusOnBackspace(event, 2)">
        <input type="text" maxlength="1" class="otp-input" id="otp-3" oninput="moveFocus(event, 3)" onkeydown="moveFocusOnBackspace(event, 3)">
        <input type="text" maxlength="1" class="otp-input" id="otp-4" oninput="moveFocus(event, 4)" onkeydown="moveFocusOnBackspace(event, 4)">
    </div>
      </div>
      <div>
...
</html><?php /**PATH C:\xampp\htdocs\projects\ayurvedicmlm\resources\views/user/otp.blade.php ENDPATH**/ ?>