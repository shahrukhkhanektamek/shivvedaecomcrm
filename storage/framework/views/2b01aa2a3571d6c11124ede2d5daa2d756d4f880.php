                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="text-align:left;">      
                                        ...
                                        <img src="<?php echo e(url('/')); ?>/public/welcome.jpg" style="width: 50%;margin: 0 auto;display: block;" title="logo" alt="logo">
                                    </td>
                                </tr>
                                    ...
                                    <td>
                                        ...
                                        <div style="display: flex;width: 100%;">
                                            <p style="margin: 10px 0 0px auto;margin-right: 15px;text-align: left;line-height: 1.4;">
                                                ...
                                                Date: <?php echo e(date("Y M, d", strtotime($orders->payment_date_time))); ?><br>
                                                Invoice No.:<?php echo e(sort_name.$user->user_id); ?>
                                        ...
                                        <div style="display: flex;width: 100%;">
                                            <p style="margin: 10px 0px 10px auto;margin-right: 15px;text-align: left;line-height: 1.4;margin-left: 15px;width: 350px;">
                                                Bill To<br>
                                                Contact Name: <?php echo e($user->name); ?><br>
                                                Contact Phone: <?php echo e($user->phone); ?><br>
                                                Address: <?php echo e($user->address); ?> , <?php echo e(@DB::table('states')->where("id",$user->state)->first()->name); ?>
                                        ...
                                        <?php $__currentLoopData = $detail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div style="display: flex;padding: 10px 0;">
                                                <span style="width: 25%;"><?php echo e($value->name); ?></span>
                                                <span style="width: 25%;"><?php echo e($value->qty); ?></span>
                                                <span style="width: 25%;"><?php echo e(Helpers::price_formate($value->amount)); ?></span>
                                                <span style="width: 25%;"><?php echo e(Helpers::price_formate($value->amount*$value->qty)); ?></span>
                                            </div>
                                        ...
                                        <div style="display: flex;background: lightgray;padding: 15px 15px 5px 0px;font-size: 14px;text-align: right;">
                                            ...
                                            <span style="width: 40%;"><?php echo e(Helpers::price_formate($orders->final_amount)); ?> (GST Included)</span>
                                        </div>
                                        <div style="display: flex;background: lightgray;padding: 5px 15px;text-align: right;">
                                            <span style="width: 60%;">Discount</span>
                                            <span style="width: 40%;"><?php echo e(Helpers::price_formate(0)); ?></span>
                                        </div>
                                        <div style="display: flex;background: lightgray;padding: 5px 15px;text-align: right;">
                                            <span style="width: 60%;font-weight: 600;">Total Amount</span>
                                            <span style="width: 40%;font-weight: 600;"><?php echo e(Helpers::price_formate($orders->final_amount)); ?></span>
                                        </div>
...
</html><?php /**PATH /home/u171934876/domains/developershahrukh.in/public_html/demo/irshad/shivveda/resources/views/mailtemplate/invoice.blade.php ENDPATH**/ ?>