                    ...
                    <?php echo $__env->make('admin.user.profile-card', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card card-animate">
                                    <div class="card-body">
                                        <a href="<?php echo e(route('kyc.view').'/'.Crypt::encryptString($row->id)); ?>">
                                            <div class="avatar-sm flex-shrink-0">
                                                <span class="avatar-title bg-success-subtle rounded fs-3">
...
</html><?php /**PATH D:\xamp\htdocs\projects\irshad\shivveda.in\resources\views/admin/user/account-view.blade.php ENDPATH**/ ?>