                            ...
                            <div class="card" id="applicationList">
                                <div class="card-header  border-0">
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-md-3">                                            
                                            <a href="<?php echo e(route('package.add')); ?>" class="btn btn-primary add-btn w-100" id="create-btn"><i class="ri-add-line align-bottom me-1"></i> Add New Package</a>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
...
</html><?php /**PATH /home/u171934876/domains/developershahrukh.in/public_html/demo/irshad/shivveda/resources/views/admin/package/index.blade.php ENDPATH**/ ?>