              ...
              <div class="row mb-3 payoutsystem" style="align-items: center;">
                 ...
                 <div class="wallet col-lg-4">
                   ...
                   <div class="walletcontent">
                     <p>Total Eearning</p>
                     <h2 class="wallet-balance"><?php echo e(Helpers::price_formate($data['totalEarning'])); ?></h2>
                    </div>
                 </div>
                 ...
                 <div class="wallet col-lg-4">
                   ...
                   <div class="walletcontent">
                     <p>Total TDS</p>
                     <h2 class="wallet-balance"><?php echo e(Helpers::price_formate($data['totalTds'])); ?></h2>
                    </div>
                 </div>
                 ...
                 <div class="wallet col-lg-4">
                   ...
                   <div class="walletcontent">
                     <p>Total R. Wallet</p>
                     <h2 class="wallet-balance"><?php echo e(Helpers::price_formate($data['totalWallet'])); ?></h2>
                    </div>
                 </div>
                 ...
                 <div class="wallet col-lg-4">
                   ...
                   <div class="walletcontent">
                     ...
                     <h2 class="wallet-balance"><?php echo e(Helpers::price_formate($data['finalEarning'])); ?></h2>
                    </div>
                 </div>
                 ...
                 <div class="wallet col-lg-4" style="    margin: 0 0 0 auto;">
                      ...
                      <div class="walletcontent">
                        ...
                        <h2 class="wallet-balance"><?php echo e(Helpers::price_formate($data['unPaid'])); ?></h2>
                       </div>
                 </div>
                 ...
                 <div class="wallet col-lg-4" style="    margin: 0 auto 0 0;">
                      ...
                      <div class="walletcontent">
                        ...
                        <h2 class="wallet-balance"><?php echo e(Helpers::price_formate($data['paid'])); ?></h2>
                       </div>
                 </div>
...
<?php echo $__env->make('user.headers.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/shivved1/public_html/resources/views/user/earning/index.blade.php ENDPATH**/ ?>