                                    ...
                                    <div class="card-body frm">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Name" name="name" value="<?php echo e(@explode(' ', $row->name)[0]); ?>" required>
                                            </div>
...
</html><?php /**PATH C:\xamp\htdocs\projects\irshad\shivvedaecomcrm\resources\views/admin/sales-man/form.blade.php ENDPATH**/ ?>