...
<head>
    <meta charset="utf-8" />
    <title>Payout List | <?php echo e(env("APP_NAME")); ?></title>
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-xl-8">
                                                <div class="row g-3">
                                                    <div class="col-sm-3">
                                                        <div class="">
                                                            <input type="date" class="form-control" id="from-date" value="<?php echo e(date('Y-m-d')); ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="">
                                                            <input type="date" class="form-control" id="to-date" value="<?php echo e(date('Y-m-d')); ?>">
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-sm-3">
...
<script>
    ...
    $(document).on("click", "#payout-confirm",(function(e) {
        ...
        var settings = {
          "url": "<?php echo e($data['back_btn']); ?>/payout_submit"+'?'+data,
          "method": "POST",
          "timeout": 0,
          "processData": false,
          "headers": {
   ...
   function get_url_data()
   {
       ...
       data = `search_type=${search_type}&amount=${amount}&user_id=${user_id}&from_date=${from_date}&to_date=${to_date}&status=${status}&order_by=${order_by}&limit=${limit}&filter_search_value=${filter_search_value}`;
   }
    get_url_data();
    url = main_url+'?'+data;
    load_table();
   ...
   function excel_export()
   {
        ...
        var form = new FormData();
        var settings = {
          "url": "<?php echo e(route('payout-history.excel_export')); ?>?"+data,
          "method": "GET",
          "timeout": 0,
          "processData": false,
          "headers": {
...
</html><?php /**PATH /home/u171934876/domains/developershahrukh.in/public_html/demo/irshad/shivveda/resources/views/admin/payout-report/index.blade.php ENDPATH**/ ?>