              ...
              <form class="form row form_data" action="<?php echo e($data['submit_url']); ?>" method="post" enctype="multipart/form-data" id="form_data_submit" novalidate>
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="input-group-addon"><i class="fa fa-star"></i></div>
                      <input class="form-control" placeholder="Your Father Name" type="text" name="father_name" value="<?php echo e(@$kyc->father_name); ?>" required>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="input-group-addon"><i class="fa fa-star"></i></div>
                      <input class="form-control" placeholder="Your Nomani Relation" type="text" name="nomani_relation" value="<?php echo e(@$kyc->nomani_relation); ?>" required>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <img src="<?php echo e(Helpers::image_check(@$kyc->passbook_image)); ?>" class="img-thumbnail mt-2 passbook_image" style="width:250px">
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <img src="<?php echo e(Helpers::image_check(@$kyc->pancard_image)); ?>" class="img-thumbnail mt-2 pancard_image" style="width:250px">
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <img src="<?php echo e(Helpers::image_check(@$kyc->aadharfront_image)); ?>" class="img-thumbnail mt-2 aadharfront_image" style="width:250px">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <img src="<?php echo e(Helpers::image_check(@$kyc->aadharback_image)); ?>" class="img-thumbnail mt-2 aadharback_image" style="width:250px">
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <?php if($row->kyc_step==1 || $row->kyc_step==0): ?>
...
<?php echo $__env->make('user.headers.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/shivved1/public_html/resources/views/user/kyc/index.blade.php ENDPATH**/ ?>