        ...
        <div class="main-content">
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <!-- end page title -->
                    <form class="mt-2 needs-validation form_data" action="<?php echo e(route('user.activate-with-income-action')); ?>" method="post" enctype="multipart/form-data" id="form_data_submit" novalidate>
                        <?php echo csrf_field(); ?>
...
</html><?php /**PATH /home/u171934876/domains/developershahrukh.in/public_html/demo/irshad/shivveda/resources/views/admin/user/activate-with-income.blade.php ENDPATH**/ ?>