          ...
          <div class="card card-outline">
            ...
            <div class="card-body">
              ...
              <form class="form row form_data" action="<?php echo e($data['submit_url']); ?>" method="get" enctype="multipart/form-data" id="form_data_submit" novalidate>
                ...
                <input type="hidden" name="amount" value="<?php echo e($data['amount']); ?>" required>
                ...
                <div class="col-md-12">
                  <div class="qr-div">
                    ...
                    <!-- <img src="https://api.qrserver.com/v1/create-qr-code/?data=upi://pay?pa=<?php echo e(urlencode($upi)); ?>&am=<?php echo e($data['amount']); ?>&cu=INR&size=300x300" alt="UPI QR Code for Payment"> -->

                    <img src="https://api.qrserver.com/v1/create-qr-code/?data=<?php echo e(urlencode('upi://pay?pa='.$upi.'&am='.$data['amount'].'&cu=INR')); ?>&size=300x300" alt="UPI QR Code for Payment">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <img class="upload-img-view img-thumbnail mt-2 mb-2 image" style="width: 100%;height: 250px;" src="<?php echo e(Helpers::image_check('','default.jpg')); ?>" alt="banner image"/>
                  </div>
                </div>
...
<script type="module">
    ...
    $(document).on("click", "#pay-submit",(function(e) {      
      ...
      form.append("amount",<?php echo e($data['amount']); ?>);
...
<?php /**PATH /home/u171934876/domains/developershahrukh.in/public_html/demo/irshad/shivveda/resources/views/user/deposit/pay.blade.php ENDPATH**/ ?>