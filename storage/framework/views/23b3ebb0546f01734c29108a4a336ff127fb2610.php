        ...
        <table class="table align-middle mb-0">
            ...
            <?php ($count = DB::table('orders')->where('user_id', $value->user_id)->count()); ?>
                <tr>
                    ...
                    <td>
                        <b>Name:</b> <?php echo e($value->salesman_name); ?><br>
                        <b>UserID:</b> <?php echo e($value->salesman_id); ?><br>
                    </td>
                    ...
                    <td><img src="<?php echo e(Helpers::image_check($value->face,'user.png')); ?>" class="img-responsive big-image" alt="User" style="width: 100px;height: 100px;cursor: pointer;"></td> 
...
<?php /**PATH C:\xamp\htdocs\projects\irshad\shivvedaecomcrm\resources\views/admin/order/table.blade.php ENDPATH**/ ?>