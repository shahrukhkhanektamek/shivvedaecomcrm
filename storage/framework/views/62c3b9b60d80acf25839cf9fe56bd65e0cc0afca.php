              ...
              <form class="form row form_data" action="<?php echo e($data['submit_url']); ?>" method="post" enctype="multipart/form-data" id="form_data_submit" novalidate>
                ...
                <div class="col-md-12">
                  <?php if($row->kyc_step==1): ?>
                    ...
                    <button type="submit" class="btn btn-success waves-effect waves-light m-r-10" id="submitKycBtn" <?php if($row->kyc_step==1): ?> style="display:none;" <?php endif; ?>>Submit</button>
                  <?php endif; ?>
                </div>
...
<?php echo $__env->make('user.headers.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamp\htdocs\projects\irshad\ayurvedicmlm\resources\views/user/kyc/index.blade.php ENDPATH**/ ?>