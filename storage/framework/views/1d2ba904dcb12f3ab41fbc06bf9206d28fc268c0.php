...
<div class="container mt-3 mt-lg-4 mt-xl-5" id="main-content">
    <div class="row gx-1 align-items-center">
        <div class="col col-sm mb-3 mb-md-4">
            <p class="small text-secondary mb-2"><?php echo e(date("d F, Y h:i A", strtotime($order->add_date_time))); ?></p>
    ...
    <div class="row gx-3 gx-lg-4">
        <div class="col-12 col-lg-8 col-xxl-9">
                        ...
                        <div class="card-body">
                            <div class="row gx-3 align-items-center flex-nowrap mb-3">
                                ...
                                <div class="col maxwidth-200">
                                    <h5 class="mb-0 text-truncated"><?php echo e($order->name); ?></h5>
                                </div>
                            </div>
                            <div class="row gx-3 gx-lg-4">
                                <div class="col-12 col-md-6">
                                    <p class="text-secondary mb-2"><i class="bi bi-envelope"></i> <?php echo e($order->email); ?></p>
                                    <p class="text-secondary mb-2"><i class="bi bi-phone"></i> <?php echo e($order->phone); ?></p>
                                    <p class="text-secondary mb-2"><i class="bi bi-map"></i> <?php ($states = DB::table('states')->where('id',$order->state)->first()); ?><?php echo e(@$states->name); ?></p>
                                    <p class="text-secondary mb-2"><i class="bi bi-map"></i> <?php echo e($order->city); ?></p>
                                    <!-- <p class="text-secondary mb-2"><i class="bi bi-map"></i> <?php echo e($order->address); ?></p> -->
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card bg-none mb-3 mb-lg-4">
                <div class="card-body">
                    <h6 class="mb-3">Order (<?php echo e(count($orderProducts)); ?> Items)</h6>
                            ...
                            <div class="row gx-3 align-items-center">
                                <div class="col-auto">
                                    <figure class="avatar avatar-50 coverimg rounded">
                                        <img src="<?php echo e(Helpers::image_check(@$value->image)); ?>" alt="">
                                    </figure>
                                </div>
                                <div class="col-9 col-md-5">
                                    <p class="mb-0 text-truncated"><?php echo e($value->name); ?></p>
