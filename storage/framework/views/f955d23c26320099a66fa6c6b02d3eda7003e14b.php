                                                        ...
                                                        <tbody id="products-list">
                                                            <?php $__currentLoopData = $detail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <tr>
                                                                    ...
                                                                    <td class="text-end"><?php echo e(Helpers::price_formate($value->amount)); ?></td>
                                                                </tr>
                                                ...
                                                <div class="border-top border-top-dashed mt-2">
                                                    <table class="table table-borderless table-nowrap align-middle mb-0 ms-auto" style="width:250px">
                                                        <tbody>
                                                            ...
                                                            <?php $__currentLoopData = json_decode($row->amount_detail); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                                            <tr>
                                                                <td><?php echo e($key); ?></td>
                                                                <td class="text-end">
                                                                <?php if($key=='Wallet Amount'): ?> - <?php endif; ?>
                                                                <?php if($key=='GST'): ?> + <?php endif; ?>
                                                                <?php echo e(Helpers::price_formate($value)); ?></td>
                                                            </tr>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
</html><?php /**PATH /home/shivved1/public_html/resources/views/admin/invoice/view.blade.php ENDPATH**/ ?>