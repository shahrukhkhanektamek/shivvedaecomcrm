        ...
        <table class="table align-middle mb-0">
            ...
            <?php $__currentLoopData = $data_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td><?php echo e($value->upi); ?></td>              
                    <td><?php echo e(Helpers::price_formate($value->amount)); ?></td>              
                    <td><?php echo e(Helpers::price_formate($value->charge)); ?></td>              
                    <td><?php echo e(Helpers::price_formate($value->withdrawal_amount)); ?></td>              
...
<?php /**PATH /home/u171934876/domains/developershahrukh.in/public_html/demo/irshad/shivveda/resources/views/admin/withdrawal/table.blade.php ENDPATH**/ ?>