                                ...
                                <div class="card">
                                    <div class="card-body frm">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <label class="form-label" for="product-title-input">Registration Email</label>
                                                <input type="email" class="form-control" placeholder="Enter Email" name="registration_email" value="<?php echo e(@$form_data->registration_email); ?>" required>
                                            </div>
...
</html><?php /**PATH /home/u171934876/domains/developershahrukh.in/public_html/demo/irshad/shivveda/resources/views/admin/setting/emails-form.blade.php ENDPATH**/ ?>