...
<div class="app-menu navbar-menu">
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="<?php echo e(route('branch.list')); ?>">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="<?php echo e(route('offer.list')); ?>">
        ...
        <!-- Left Sidebar End --><?php /**PATH D:\xamp\htdocs\projects\irshad\shivvedaecomcrm\resources\views/admin/headers/header.blade.php ENDPATH**/ ?>