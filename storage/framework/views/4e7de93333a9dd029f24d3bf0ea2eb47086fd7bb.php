...
<footer class="adminuiux-mobile-footer hide-on-scrolldown style-1">
    <div class="container">
        <ul class="nav nav-pills nav-justified">
            <li class="nav-item">
                <a class="nav-link" href="<?php echo e(url('salesman/product')); ?>">
                    <span>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo e(url('salesman/my-order')); ?>">
                    <span>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo e(url('salesman/cart')); ?>">
                    <span>
...
$(document).on('click',".logout",function (e) {
  ...
  $.ajax({
      ...
      url:"<?php echo e(route('salesman.salesman-logout')); ?>",
...
<script>
   ...
   $(document).on("click", ".plus-btn, .devide-btn",(function(e) {
      ...
      loader("show");
        ...
        form.append("qty",qty);
        var settings = {
          "url": "<?php echo e(route('salesman.cart.add')); ?>",
          "method": "POST",
          "timeout": 0,
          "processData": false,
          "headers": {
...
</html><?php /**PATH C:\xamp\htdocs\projects\irshad\shivvedaecomcrm\resources\views/salesman/include/footer.blade.php ENDPATH**/ ?>