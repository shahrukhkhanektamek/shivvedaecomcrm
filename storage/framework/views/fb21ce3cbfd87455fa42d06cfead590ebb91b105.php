                                    ...
                                    <div class="card-body frm">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <input type="number" class="form-control" placeholder="Enter Position" name="position" value="<?php echo e(@$row->position); ?>" required>
                                            </div>
                                            <div class="col-lg-4">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <label>
                                                    <input class="form-control upload-single-image" type="file" name="display_image" data-target="offer_image">
                                                    <img class="upload-img-view img-thumbnail mt-2 mb-2 offer_image" id="viewer" 
                                                        src="<?php echo e(Helpers::image_check(@$row->offer_image)); ?>" alt="banner image"/>
                                                </label>
                                            </div>
                                            <div class="col-lg-4">
                                                ...
                                                <label>
                                                    ...
                                                    <img class="upload-img-view img-thumbnail mt-2 mb-2 offer_image2" id="viewer" 
                                                        src="<?php echo e(Helpers::image_check(@$row->offer_image2)); ?>" alt="banner image"/>
                                                </label>
                                            </div>
                                            <div class="col-lg-4">
...
</html><?php /**PATH /home/u171934876/domains/developershahrukh.in/public_html/demo/irshad/shivveda/resources/views/admin/package/form.blade.php ENDPATH**/ ?>