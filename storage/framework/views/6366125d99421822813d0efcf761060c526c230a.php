        ...
        <div class="col-lg-12 mt-3">
          <div class="card card-outline">
            <div class="card-header bg-blue">
              <h5 class="text-white m-b-0"><?php echo e($data['title']); ?> <?php if(!empty($data['level'])): ?> <?php echo e($data['level']); ?> <?php endif; ?> History</h5>
            </div>
...
<script>
   ...
   {       
       ...
       data = `type=${type}&from_date=${from_date}&to_date=${to_date}&level=<?php echo e($data['level']); ?>`;
   }
   get_url_data()
   url = main_url+'?'+data;
   load_table();
...
<?php echo $__env->make('user.headers.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/shivved1/public_html/resources/views/user/lavel/index.blade.php ENDPATH**/ ?>