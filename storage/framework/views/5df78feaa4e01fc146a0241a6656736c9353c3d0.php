...
<div class="login-box">
  <div class="login-box-body">
      ...
      <div>
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <a href="<?php echo e(route('user.user-forgot')); ?>" class="pull-right"><i class="fa fa-lock"></i> Forgot pwd?</a>
          </div>
        </div>
        <!-- /.col -->
    ...
    <div class="m-t-2">Don't have an account? <a href="<?php echo e(route('user.registration')); ?>" class="text-center">Sign Up</a></div>
  </div>
  <!-- /.login-box-body --> 
</div>
<!-- /.login-box --> 
...
</html><?php /**PATH D:\xamp\htdocs\projects\irshad\ayurvedicmlm\resources\views/user/login.blade.php ENDPATH**/ ?>