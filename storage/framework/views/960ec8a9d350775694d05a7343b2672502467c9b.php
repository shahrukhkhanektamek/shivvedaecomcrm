        ...
        <div class="col-lg-12">
          <div class="card card-outline">
            ...
            <div class="card-body">
              ...
              <?php if($incomePlan->type==2): ?>

                <?php if($user->total_bv<$incomePlan->id_bv && $user->is_paid==0): ?>
                  <div class="alert alert-info">
                    <p class="m-0">Purchase any products and complete your <?php echo e($incomePlan->id_bv); ?> BV You have <?php echo e($user->total_bv); ?> bv now and activate your Id.</p>
                  </div>
                <?php endif; ?>
...
<script>
   var data = '';
   var main_url = "<?php echo e(route('user.product.list')); ?>/load_data";
   ...
   var qty = 0;
   var cartDetail = '';
   var setBv = '<?php echo e($incomePlan->id_bv); ?>';
...
<?php echo $__env->make('user.headers.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamp\htdocs\projects\irshad\shivveda.in\resources\views/user/activation/index.blade.php ENDPATH**/ ?>