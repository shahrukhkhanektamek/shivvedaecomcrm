...
<head>
    ...
    <title> Refund Policy &ndash; Shivveda Private Limited</title>
...
<p>Once the Product is received to the company successfully, Shivveda Private Limited will instantly initiate the refund, which will take 8-9 business days to reach your source account or chosen method of refund.</p>
<p><strong>Cancellation Policy</strong></p>
<p>Please note an order can only be canceled within 24 hours of placing the order. Once the order&nbsp;<br>is processed after 24 hours, no cancellation request will be entertained. However return is possible for all orders/products.<br>OR<br>Customers can CANCEL order only before the Order has been shipped/Dispatched. After the Product/s have been shipped, The Customer CANNOT Cancel the Orders. However return &nbsp;is possible for all orders/products.</p>
<p><strong>Shipping &amp; Delivery Policies -</strong></p>
<p>Shivveda Pvt Ltd ships its products to almost all parts of India. Orders placed will be shipped within 48 hrs. We ship on all days except Sunday and National Holidays.<br>For all areas serviced by reputed couriers, the delivery time would be within 5 to 7 business days of shipping (business days exclude Sundays and other holidays). For other areas the products will be shipped through other courier services and may take 1-2 weeks depending on location. At times there might be unexpected delays in the delivery of your order due to unavoidable and undetermined logistics challenges beyond our control for which Shivveda Pvt Ltd is not liable and would<br>request its users to cooperate as Shivveda Pvt Ltd continuously tries to sought such instances.<br>Also, Shivveda Pvt Ltd reserves the right to cancel your order at its sole discretion in cases where it takes longer than usual delivery time or the shipment is physically untraceable and refund the amount paid for cancelled product(s) to your source account.</p>
    </div>
  </div>
...
</html><?php /**PATH /home/shivved1/public_html/resources/views/web/refund-policy.blade.php ENDPATH**/ ?>