...
<h2 id="ctl00_ContentPlaceHolder1_lblusername" style="font-size: 27px;margin: 0 0 10px 0;font-weight: 900;color: black;background: #ffffff;padding: 7px 0;text-transform: uppercase;width: fit-content;display: block;margin: 0px auto;margin-bottom: 10px;padding: 5px 10px;"><?php echo e($row->name); ?></h2>
                                    ...
                                    <div class="col-lg-12">
                                        <p class="clearfix">
                                          ...
                                          <span class="float-right"><i class="fa fa-rupee-sign"></i><?php echo e(@\App\Models\MemberModel::totalTeam($row->id)); ?> Partners</span>
                                        </p>
                                        <p class="clearfix">
                                          <span class="float-left">My Direct Paid</span>
                                          <span class="float-right"><i class="fa fa-rupee-sign"></i><?php echo e(@\App\Models\MemberModel::totalDirect($row->id,1)); ?> Partners</span>
                                        </p>
                                        <p class="clearfix">
                                          <span class="float-left">My Direct UnPaid</span>
                                          <span class="float-right"><i class="fa fa-rupee-sign"></i><?php echo e(@\App\Models\MemberModel::totalDirect($row->id,2)); ?> Partners</span>
                                        </p>
                                        <p class="clearfix">
                                          <span class="float-left">My Matching</span>
                                          <span class="float-right"><i class="fa fa-rupee-sign"></i><?php echo e($row->total_pairs); ?> Pairs</span>
                                        </p>
                                        <p class="clearfix">
                                          <span class="float-left">Total Self RBV</span>
                                          <span class="float-right"><i class="fa fa-rupee-sign"></i><?php echo e($row->total_bv); ?></span>
                                        </p>

                                        <p class="clearfix">
                                          <span class="float-left">Total Left Team RBV</span>
                                          <span class="float-right"><i class="fa fa-rupee-sign"></i><?php echo e($row->left_bv); ?></span>
                                        </p>

                                        <p class="clearfix">
                                          <span class="float-left">Total Right Team RBV</span>
                                          <span class="float-right"><i class="fa fa-rupee-sign"></i><?php echo e($row->right_bv); ?></span>
                                        </p>

                                        <p class="clearfix">
                                          <span class="float-left">Left Paid Partners</span>
                                          <span class="float-right"><i class="fa fa-rupee-sign"></i><?php echo e($row->total_left_paid); ?></span>
                                        </p>
                                        <p class="clearfix">
                                          <span class="float-left">Right Paid Partners</span>
                                          <span class="float-right"><i class="fa fa-rupee-sign"></i><?php echo e($row->total_right_paid); ?></span>
                                        </p>
                                        <p class="clearfix">
                                          <span class="float-left">Left Unpaid Partners</span>
                                          <span class="float-right"><i class="fa fa-rupee-sign"></i><?php echo e($row->total_left_unpaid); ?></span>
                                        </p>
                                        <p class="clearfix">
                                          <span class="float-left">Right Unpaid Partners</span>
                                          <span class="float-right"><i class="fa fa-rupee-sign"></i><?php echo e($row->total_right_unpaid); ?></span>
                                        </p>
                                    </div>
                                                ...
                                                <table class="table table-respinsive">
                                                    ...
                                                    <tbody>
                                                      ...
                                                      <tr>
                                                        ...
                                                        <td><?php if($row->rank>=7): ?> <span class="text-bold text-green">Completed</span> <?php else: ?> <i class="bx bx-loader-circle bx-spin"></i> <?php endif; ?> 10,00,000/-</td>
                                                      </tr>
                                                      <tr>
                                                        <td>8</td>
...
</html><?php /**PATH D:\xamp\htdocs\projects\irshad\shivveda.in\resources\views/admin/user/dashboard.blade.php ENDPATH**/ ?>