<div class="person">
    ...
    <?php endif; ?>
    <p class="name">
        <a style="color: #000000;" href="<?php echo e(url('user/team').'/'.Crypt::encryptString($member_detail->id)); ?>"><?php echo e($member_detail->name); ?>/<b><?php echo e(sort_name); ?><?php echo e($member_detail->user_id); ?></b></a><br>
    ...
    <div class="detail-popup">
        ...
        <p><b>Pairs : </b><?php echo e($member_detail->total_pairs); ?></p>
        <p><b>Rank : </b><?php echo e(@\App\Models\MemberModel::rank($member_detail->rank)); ?></p>
        ...
        <p><b>Direct Income : </b><?php echo e(Helpers::price_formate($member_detail->income1)); ?></p>
        <p><b>Pair Income : </b><?php echo e(Helpers::price_formate($member_detail->income2)); ?></p>
        <p><b>Downline Income : </b><?php echo e(Helpers::price_formate($member_detail->income3)); ?></p>
        <p><b>Upline Income : </b><?php echo e(Helpers::price_formate($member_detail->income4)); ?></p>
        <p><b>Rank Bonus Income : </b><?php echo e(Helpers::price_formate($member_detail->income5)); ?></p>
        <p><b>Left BV : </b><?php echo e(Helpers::price_formate($member_detail->left_bv)); ?></p>
        <p><b>Right BV : </b><?php echo e(Helpers::price_formate($member_detail->right_bv)); ?></p>
...
</div><?php /**PATH /home/shivved1/public_html/resources/views/user/team/team-card.blade.php ENDPATH**/ ?>