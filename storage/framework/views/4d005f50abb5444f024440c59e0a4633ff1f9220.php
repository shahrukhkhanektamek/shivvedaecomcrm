                ...
                <div class="col-lg-4" style="margin: 0 auto;">
                    ...
                    <div class="user-profile-box m-b-3">
                      ...
                      <div class="box-profile text-white">
                        <img class="profile-user-img img-responsive img-circle m-b-2" src="<?php echo e(Helpers::image_check($row->image,'user.png')); ?>" alt="User profile picture">
                        <a href="<?php echo e(route('user.profile-image.edit')); ?>" class="badge badge-primary p-1" style="margin: 0 auto;display: block;width: fit-content;margin-bottom: 10px;">Update Image</a>
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input class="form-control" placeholder="First Name" type="text" name="name" value="<?php echo e(@explode(' ', $row->name)[0]); ?>" required>
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input class="form-control" placeholder="Last Name" type="text" name="lname" value="<?php echo e(@explode(' ', $row->name)[1]); ?>" >
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input class="form-control" placeholder="Email" type="email" name="email" value="<?php echo e($row->email); ?>" >
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input class="form-control" placeholder="Phone" type="number" name="phone" value="<?php echo e($row->phone); ?>"  >
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input class="form-control" placeholder="City" type="text" name="city" value="<?php echo e($row->city); ?>" >
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input class="form-control" placeholder="Address" type="text" name="address" value="<?php echo e($row->address); ?>" >
...
<?php /**PATH /home/shivved1/public_html/resources/views/user/profile/index.blade.php ENDPATH**/ ?>