...
<head>
    ...
    <link rel="apple-touch-icon" href="<?php echo e(url('/public/salesman/')); ?>/assets/img/favicon.png">
    ...
    <script defer src="<?php echo e(url('/public/salesman/')); ?>/assets/js/app.js"></script>
    <link href="<?php echo e(url('/public/salesman/')); ?>/assets/css/app.css" rel="stylesheet">
...
<div class="adminuiux-wrap">
    ...
    <div class="adminuiux-sidebar">
        <div class="adminuiux-sidebar-inner">
            <ul class="nav flex-column menu-active-line mt-3">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(url('/salesman/product')); ?>" class="nav-link">
                        <i class="menu-icon bi bi-boxes"></i>
                        <span class="menu-name">Products</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo e(url('/salesman/change-password')); ?>" class="nav-link">
    ...
    <main class="adminuiux-content has-sidebar" onclick="contentClick()"><?php /**PATH C:\xamp\htdocs\projects\irshad\shivvedaecomcrm\resources\views/salesman/include/header.blade.php ENDPATH**/ ?>