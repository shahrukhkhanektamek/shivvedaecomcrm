        ...
        <div class="main-content">
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <!-- end page title -->
                    <form class="mt-2 needs-validation form_data" action="<?php echo e(route('user.change-password-action')); ?>" method="post" enctype="multipart/form-data" id="form_data_submit" novalidate>
                        <?php echo csrf_field(); ?>
                                ...
                                <div class="card">
                                    <div class="card-body frm">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <label class="form-label" for="product-title-input">New Password </label>
                                                <input type="text" class="form-control" placeholder="New Password" name="password" value="" required>
                                            </div>
                                            
                                            <div class="col-lg-6">
                                                <label class="form-label" for="product-title-input">Confirm Password </label>
                                                <input type="text" class="form-control" placeholder="Confirm Password" name="cpassword" value="" required>
                                            </div>
...
</html><?php /**PATH /home/u171934876/domains/developershahrukh.in/public_html/demo/irshad/shivveda/resources/views/admin/user/change-password.blade.php ENDPATH**/ ?>