...
<?php if($user->id!=4): ?>
                <div class="wallet mnwallet wallets" style="margin: 0 auto;margin-bottom: 15px;">
                  ...
                  <div class="walletcontent">
                    <p>Total BV</p>
                    <h2 class="wallet-balance" id="totalBv"><?php echo e(($data['totalBv'])); ?></h2>                   
                  </div>
                </div>  
<?php endif; ?>
...
<?php echo $__env->make('user.headers.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamp\htdocs\projects\irshad\shivvedaecomcrm\resources\views/user/my-order/index.blade.php ENDPATH**/ ?>