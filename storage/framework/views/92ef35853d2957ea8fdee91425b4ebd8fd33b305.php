                  ...
                  <div class="table-responsive">
                    ...
                    <?php $__currentLoopData = $orderProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-12 mb-3 card">
                          ...
                          <p class="mb-1"><strong>Price:</strong> <?php echo e(Helpers::price_formate($value->price)); ?></p>
                          <p class="mb-1"><strong>Total QTY:</strong> <?php echo e($value->qty); ?></p>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <th>Sub Total</th>
                            <th><?php echo e(Helpers::price_formate($subTotal)); ?></th>
                          </tr>
                          <tr>
                            <th>Gst</th>
                            <th>+<?php echo e(Helpers::price_formate($gstAmount)); ?></th>
                          </tr>
                          <tr>
                            <th>Total Amount</th>
                          ...
                          <tr>
                            <th>Wallet Amount</th>
                            <th>-<?php echo e(Helpers::price_formate($order->wallet_amount)); ?></th>
                          </tr>
                          <tr>
                            <th>Payable Amount</th>
                            <th><?php echo e(Helpers::price_formate($order->final_amount-$order->wallet_amount)); ?></th>
                          </tr>

                          <tr>
                            <th>Total BV: </th>
                            <th><?php echo e($order->bv); ?></th>
                          </tr>
...
<?php echo $__env->make('user.headers.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/shivved1/public_html/resources/views/user/my-order/view.blade.php ENDPATH**/ ?>