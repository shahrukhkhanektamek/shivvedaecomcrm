...
<script>
    var data = '';
    var main_url = "<?php echo e(route('user.get_tree')); ?>";
     var windowWidth = window.innerWidth;
    function get_url_data()
   {
       data = `id=<?php echo e($id); ?>&windowWidth=${windowWidth}`;
   }
    function load_table()
    {
...
<?php /**PATH /home/shivved1/public_html/resources/views/user/team/index.blade.php ENDPATH**/ ?>