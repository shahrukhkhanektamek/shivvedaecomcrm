...
<script>
    ...
    function excel_export()
   {
        ...
        var form = new FormData();
        var settings = {
          "url": "<?php echo e(route('user.right-team.excel_export')); ?>?"+data,
          "method": "GET",
          "timeout": 0,
          "processData": false,
          "headers": {
...
<?php echo $__env->make('user.headers.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/shivved1/public_html/resources/views/user/right-team/index.blade.php ENDPATH**/ ?>