                ...
                <div class="row">
                    <div class="col-lg-6" style="margin: 0 auto;">
                        ...
                        <div class="crop-div">
                            ...
                            onerror="this.src='<?php echo e(asset('storage/app/public/upload/user.png')); ?>'"
                            src="<?php echo e(asset('storage/app/public/upload/')); ?>/<?php echo e(@$row->image); ?>" alt="banner image"/ style="width: 100%;">
                        </div>
                    </div>
    ...
    $('#cropButton').on('click', function() {
        if (cropper) {
            ...
            canvas.toBlob(function(blob) {
                ...
                formData.append('id', '<?php echo e(Crypt::encryptString(@$row->id)); ?>');
...
</script><?php /**PATH /home/shivved1/public_html/resources/views/user/profile-image/form.blade.php ENDPATH**/ ?>