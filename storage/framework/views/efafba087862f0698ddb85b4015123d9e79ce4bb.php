...
<div class="login-box">
  <div class="login-box-body">
    ...
    <form class="account__form form_data" action="<?php echo e(route('user.user-create-password-submit')); ?>" method="post" enctype="multipart/form-data" id="form_data_submit" novalidate>
    <?php echo csrf_field(); ?>
...
</html><?php /**PATH /home/u171934876/domains/developershahrukh.in/public_html/demo/irshad/shivveda/resources/views/user/create_password.blade.php ENDPATH**/ ?>