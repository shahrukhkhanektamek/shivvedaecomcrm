...
<div class="login-box col-md-8" style="width: auto;">
  <div class="login-box-body">
    ...
    <form class="account__form row form_data" action="<?php echo e(route('user.user-register-otp-send-action')); ?>" method="post" enctype="multipart/form-data" id="form_data_submit" novalidate>
    <?php echo csrf_field(); ?>
      ...
      <div class="col-md-4">
        <div class="form-group">
          ...
          <div class="input-group">
            ...
            <input class="form-control" placeholder="Sponser ID." type="number" name="sponser_id" id="sponser_id" required value="<?php echo e(@$data['sponser_id']); ?>">
          </div>
        </div>
      </div>
        ...
        <div class="form-group">
          ...
          <div class="input-group">
            ...
            <select class="form-select mb-3" aria-label="Default select example" name="placement" id="placement" required >
              ...
              <option value="1" <?php if(@$data['placement']=='left'): ?> selected <?php endif; ?>>Left</option>
              <option value="2" <?php if(@$data['placement']=='right'): ?> selected <?php endif; ?>>Right</option>
            </select>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="form-group">
          ...
          <div class="input-group">
            ...
            <input class="form-control" placeholder="Sponser Name" type="text" id="sponser_name" readonly required value="<?php echo e($data['sponser_name']); ?>">
          </div>
...
</html><?php /**PATH /home/u171934876/domains/developershahrukh.in/public_html/demo/irshad/shivveda/resources/views/user/registration.blade.php ENDPATH**/ ?>