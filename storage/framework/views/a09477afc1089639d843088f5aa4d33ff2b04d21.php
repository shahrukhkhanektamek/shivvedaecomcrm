<div class="person">
    ...
    <?php endif; ?>
    <p class="name">
        <a style="color: #000000;" href="<?php echo e(url('tree').'?id='.($member_detail->id)); ?>"><?php echo e($member_detail->name); ?>/<b><?php echo e(sort_name); ?><?php echo e($member_detail->user_id); ?></b></a><br>
...
</div><?php /**PATH /home/shivved1/public_html/resources/views/web/tree/team-card.blade.php ENDPATH**/ ?>