...
<head>
    <meta charset="utf-8" />
    <title>Income Report | <?php echo e(env("APP_NAME")); ?></title>
                                            ...
                                            <div class="col-md-1">
                                             ...
                                             <div class="col-md-2">
                                                <select class="form-control type" id="type">
                                                   ...
                                                   <option value="2">Lavel 1</option>
                                                   <option value="3">Lavel 2</option>
                                                   <option value="4">Lavel 3</option>
                                                   <option value="5">By Admin</option>
                                                </select>
                                             </div>     
...
</html><?php /**PATH /home/u171934876/domains/developershahrukh.in/public_html/demo/irshad/shivveda/resources/views/admin/income-report/index.blade.php ENDPATH**/ ?>