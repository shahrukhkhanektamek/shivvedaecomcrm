                                    ...
                                    <div class="card-body frm">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter GST" name="gst" value="<?php echo e(@$form_data->gst); ?>" required>
                                            </div>

                                            <div class="col-lg-4">
                                                <label class="form-label" for="product-title-input">TDS</label>
                                                <input type="text" class="form-control" placeholder="Enter TDS" name="tds" value="<?php echo e(@$form_data->tds); ?>" required>
                                            </div>
...
</html><?php /**PATH D:\xamp\htdocs\projects\irshad\ayurvedicmlm\resources\views/admin/setting/gst-form.blade.php ENDPATH**/ ?>