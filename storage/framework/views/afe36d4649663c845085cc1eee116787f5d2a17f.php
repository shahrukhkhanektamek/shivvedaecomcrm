                                    ...
                                    <div class="card-body frm">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Title" name="title" value="<?php echo e(@$row->title); ?>" required>
                                            </div>
                                            
                                            <div class="col-lg-4">
                                                <label class="form-label" for="product-title-input">URL</label>
                                                <input type="text" class="form-control" placeholder="Enter URL" name="url" value="<?php echo e(@$row->url); ?>" required>
                                            </div>
...
</html><?php /**PATH /home/shivved1/public_html/resources/views/admin/offer/form.blade.php ENDPATH**/ ?>