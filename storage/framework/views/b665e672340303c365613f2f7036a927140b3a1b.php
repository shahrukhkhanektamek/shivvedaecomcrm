...
<div class="login-box col-md-8" style="width: auto;">
  <div class="login-box-body">
    ...
    <form class="account__form row form_data" action="<?php echo e(route('user.user-register-action')); ?>" method="post" enctype="multipart/form-data" id="form_data_submit" novalidate>
    <?php echo csrf_field(); ?>
      ...
      <div class="col-md-4">
        <div class="form-group">
          ...
          <div class="input-group">
            ...
            <input class="form-control" placeholder="Sponser ID." type="number" name="sponser_id">
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="form-group">
          ...
          <div class="input-group">
            ...
            <select class="form-select mb-3" aria-label="Default select example" name="placement" id="placement">
      ...
      <div class="col-md-4">
        <div class="form-group">
          ...
          <div class="input-group">
            ...
            <input class="form-control" placeholder="Sponser Name" type="text">
          </div>
        </div>
      </div>
      ...
      <div class="col-md-8">
        <div class="form-group">
          ...
          <div class="input-group">
            ...
            <input class="form-control" placeholder="Phone" type="number" name="mobile">
          </div>
        </div>
      </div>
...
</html><?php /**PATH C:\xampp\htdocs\projects\ayurvedicmlm\resources\views/user/registration.blade.php ENDPATH**/ ?>